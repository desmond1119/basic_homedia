  ...
  public: {
    Tables: {
      ...
      reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "reviews_portfolio_id_fkey"
    ...
    Views: {
      admin_stats: {
        Row: {
          ...
          pending_portfolios: number | null
          total_comments: number | null
          total_homeowners: number | null
    ...
    Functions: {
      ...
      user_liked_target: {
        Args:
          | { target_type_str: string; target_uuid: string; user_uuid: string }
          | { target_type_str: string; target_uuid: string; user_uuid: string }
        Returns: boolean
      }
    }
    Enums: {
      user_role: "admin" | "provider" | "homeowner"
    }
    CompositeTypes: {
      [_ in never]: never
    }
